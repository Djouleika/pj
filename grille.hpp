...
EnsCoord voisinespece(grille g,coord c, Espece e);
    /* Affiche tous les voisins de l'espece indiquée
     
       @param g une grille
       
       @param c la coordonnée de l'animal
       
       @param e l'espece qu'on cherche
       
       @return les voisins dans la grille autour de la coordonée et l'espece donnée
       */

EnsCoord voisinvide(grille g,coord c);
 /* Afficher le nombre de cases voisines d'une case
    @param g la grille sur laquelle on travaille
    @param c la coordonnée de la case
    @return les voisins vides de cette case 
